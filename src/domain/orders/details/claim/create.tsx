                    ...
                    <div className="mt-4">
                        ...
                        {returnShippingMethod && (
                            <RMAShippingPrice
                                ...
                                shippingPrice={
                                    customOptionPrice.return || undefined
                                }
                                currencyCode={
                                    returnShippingMethod.region.currency_code
                                }
                        ...
                        <div className="mt-8">
                            ...
                            <div>
                                ...
                                <span className="inter-small-regular text-grey-50">
                                    Shipping new items is free by default. Use
                                    custom price, if this is not the case
                                </span>
                                <Select
                                    label="Shipping Method"
                                    className="mt-2"
