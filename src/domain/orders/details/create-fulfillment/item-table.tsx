...
const CreateFulfillmentItemsTable = ({
    ...
    const handleQuantity = (upOrDown: any, item: any) => {
    ...
    const handleFulfillmentItemToggle = (item: any) => {
        const id = item.id
                                ...
                                <Table.Cell className="w-[50px]">
                                    <div className="items-center ml-1 h-full flex">
                                        <div
                                            ...
                                            className={`w-5 h-5 flex justify-center text-grey-0 border-grey-30 border cursor-pointer rounded-base ${checked && 'bg-violet-60'
                                                }`}
                                        >
