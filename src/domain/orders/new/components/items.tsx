...
const Items: React.FC<ItemsProps> = ({
    ...
    const addCustomItem = (title: any, quantity: any, amount: any) => {
        handleAddCustom({
            title,
            unit_price: amount,
            quantity: quantity,
            ...
            {items.length > 0 && (
                <Table>
                    ...
                    {items.map((item: any, index: number) => {
                        const itemPrice = extractUnitPrice(
                            item,
                            selectedRegion,
                            false
                        )
...
const CreateCustomProductScreen = (pop: any, onSubmit: any, region: any): any => {
    return {
