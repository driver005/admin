...
interface SelectShippingMethodProps {
    ...
    shippingOption: any
    showCustomPrice: any
    setShowCustomPrice: any
    setCustomOptionPrice: any
    customOptionPrice: any
    region: any
}
            ...
            {!shippingOptions?.length ? (
                <div className="inter-small-regular mt-6 p-4 text-orange-50 bg-orange-5 rounded-rounded flex text-grey-50">
                    ...
                    <div className="flex flex-col">
                        ...
                        You don't have any options for orders without shipping.
                        Please add one (e.g. "In-store fulfillment") with "Show
                        on website" unchecked in region settings and continue.
                    </div>
                </div>
            ) : (
                <div className="mt-4">
