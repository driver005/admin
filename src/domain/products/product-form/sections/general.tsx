...
const General: React.FC<GeneralProps> = ({ showViewOptions = true, isEdit = false, product }) => {
    ...
    return (
        ...
        >
            <div className="mt-large">
                ...
                >
                    Give your product a short and clear name. 50-60 characters
...
type GeneralBodyCardProps = BodyCardProps & {
    isEdit: boolean
    product: any
}

const GeneralBodyCard: React.FC<GeneralBodyCardProps> = ({ isEdit, product, ...props }) => {
