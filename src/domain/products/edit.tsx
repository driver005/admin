...
type EditProductPageProps = RouteComponentProps & {
    id?: any
}

const EditProductPage: React.FC<EditProductPageProps> = ({ id }) => {
    ...
    const onSubmit = async (data: any) => {
        ...
        const images = data.images
            .filter((img: any) => img.url.startsWith('blob'))
            .map((img: any) => img.nativeFile)
