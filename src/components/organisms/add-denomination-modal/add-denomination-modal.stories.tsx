...
import AddDenominationModal from '.'
...
export default {
    title: 'Organisms/AddDenominationModal',
    component: AddDenominationModal,
} as ComponentMeta<typeof AddDenominationModal>

const Template: ComponentStory<typeof AddDenominationModal> = (args) => (
    <AddDenominationModal {...args} />
)
