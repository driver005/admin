...
interface VariantGridProps {
    ...
    variants: any
    edit: any
    onVariantsChange: any
}

const VariantGrid: React.FC<VariantGridProps> = ({ product, variants, edit, onVariantsChange }) => {
    ...
    const getDisplayValue = (variant: any, column: any) => {
    ...
    const handleDuplicateVariant = async (variant: any) => {
        console.log(variant)
    ...
    const editVariantActions = (variant: any) => {
        return [
            {
                label: 'Edit',
