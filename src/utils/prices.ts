...
export const extractUnitPrice = (item: any, region: any, withTax = true) => {
...
export const extractOptionPrice = (
    price: any,
    region: { tax_rate: number; currency_code: string }
) => {
    let amount = price
...
export const stringDisplayPrice = ({ amount, currencyCode }: any) => {
